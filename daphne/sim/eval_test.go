...
func TestGetConsensusFactory_MapsProtocolNameToImplementation(t *testing.T) {
	tests := map[string]consensus.Factory{
		...
		"a":         dag.Factory[payload.Transactions]{LayeringFactory: autocracy.Factory[payload.Transactions]{}},
		"autocrat":  dag.Factory[payload.Transactions]{LayeringFactory: autocracy.Factory[payload.Transactions]{}},
		"l":         dag.Factory[payload.Transactions]{LayeringFactory: lachesis.Factory[payload.Transactions]{}},
		"lachesis":  dag.Factory[payload.Transactions]{LayeringFactory: lachesis.Factory[payload.Transactions]{}},
		"":          central.Factory{},
		"bla":       central.Factory{},
	}
