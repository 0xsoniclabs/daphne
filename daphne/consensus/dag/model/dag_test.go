...
func TestDag_AddEvent_GenesisEventsAreImmediatelyConnected(t *testing.T) {
	dag := NewDag[payload.Transactions]()

	genesisEvent := EventMessage[payload.Transactions]{Creator: 1}
...
func TestDag_AddEvent_EventSequencesImmediatelyConnectedWhenAdded(t *testing.T) {
	...
	eventMessage1 := EventMessage[payload.Transactions]{Creator: 1}
	eventMessage2 := EventMessage[payload.Transactions]{Creator: 1, Parents: []EventId{eventMessage1.EventId()}}
...
func TestDag_AddEvent_AddingDuplicateToPendingDoesNotDoAnything(t *testing.T) {
	...
	eventMessage := EventMessage[payload.Transactions]{Creator: 1, Parents: []EventId{randomId}}

	connected1 := dag.AddEvent(eventMessage)
	require.Empty(t, connected1, "First addition should put it in pending")
	require.ElementsMatch(t, dag.pending, []EventMessage[payload.Transactions]{eventMessage},
...
func TestDag_AddEvent_CannotConnectAnEventTwice(t *testing.T) {
	...
	eventMessage := EventMessage[payload.Transactions]{Creator: 1}
...
func TestDag_AddEvent_PanicOnInvalidEventMessage(t *testing.T) {
	dag := NewDag[payload.Transactions]()
	parentEvent := EventMessage[payload.Transactions]{Creator: 2}
	dag.AddEvent(parentEvent)

	// Create an event message with a first parent that is not the self-parent.
	eventMessage := EventMessage[payload.Transactions]{Creator: 1, Parents: []EventId{parentEvent.EventId()}}
...
func TestDag_GetHeads(t *testing.T) {
	...
	event1 := EventMessage[payload.Transactions]{Creator: 1}
	event2 := EventMessage[payload.Transactions]{Creator: 2}
	...
	event3 := EventMessage[payload.Transactions]{Creator: 1, Parents: []EventId{event1.EventId()}}
	dag.AddEvent(event3)
