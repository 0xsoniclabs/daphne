...
// func TestDekima_IsALayeringImplementation(t *testing.T) {
// 	var _ layering.Layering = &Dekima{}
// }
...
// 	lachesis := newDekima(dag, committee)
...
// func TestLachesis_IsCandidate_ReturnsTrueForFirstInFrameByCreator(t *testing.T) {
// 	require := require.New(t)
...
// 	require.True(lachesis.IsCandidate(e_1_2))
