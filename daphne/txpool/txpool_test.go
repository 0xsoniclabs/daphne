...
func TestTxPool_AddingToOnePoolWithoutErrorCausesOtherPoolToReceiveTransaction(t *testing.T) {
...
func TestTxPool_AddingToOnePoolWithErrorDoesNotBroadcastTransaction(t *testing.T) {
	network := p2p.NewNetwork()
